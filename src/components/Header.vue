<template>
  <div class="flex justify-center p-6">
    <div class="w-screen max-w-screen-xl flex justify-center md:justify-start divide-x divide-current font-mono font-bold gap-5">
      <div class="flex flex-col justify-center">
        <h1 class="text-2xl">晒你动漫社视频组</h1>
